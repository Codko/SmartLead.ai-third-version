...
import Integrationcontent from "../../components/Content/Integrationcontent";
import { div } from "motion/react-client";

const Section3 = () => {
  return (

      <div className="w-full flex flex-col items-center px-4 py-16 -mt-[600px] lg:-mt-[1400px]">
        <Integrationcontent />
        <div className="grid grid-cols-1 md:grid-cols-2 max-w-[1480px] mx-auto -mt-[100px]  xl:border-[#E5E7EB]">
          <div className="w-full h-[480px] flex flex-col text-left xl:border-b xl:border-r xl:border-[#E5E7EB] p-8">
            ...
            >
              Let Smart Agent handle your outreach from prospecting to
              follow-ups — so you can focus on closing deals.
            </p>
          </div>

          <div className="w-full h-[480px] flex flex-col justify-center items-center text-left xl:border-b  xl:border-[#E5E7EB] p-4">
